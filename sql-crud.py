...
# Create entries for Programmer table
...
john_kraft = Programmer(
    first_name="John",
    last_name="Kraft",
    gender="M",
    nationality="British",
    famous_for="Staring blankly at walls"
)

# Add new entries to our session
...
# session.add(john_kraft)

# update single record
# programmer = session.query(Programmer).filter_by(id=7).first()
# programmer.famous_for = "Actual idiot"
...
# query database to see all programmers
